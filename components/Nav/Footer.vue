<template>
  <div class="px-24 h-20 py-5 border-t border-primary-100 dark:border-neutral-600 justify-between items-center inline-flex w-full bg-white dark:bg-neutral-800">
    <UIP bold="semibold" color="text-primary-400 dark:text-green-400">Copyright © 2024. FOP "Bogdan Savrak Mykhailovich". All Rights Reserved</UIP>
